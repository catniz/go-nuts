...
func (scu *SystemConfigUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(systemconfig.Table, systemconfig.Columns, sqlgraph.NewFieldSpec(systemconfig.FieldID, field.TypeUint64))
	...
	_spec.Node.Schema = scu.schemaConfig.SystemConfig
...
func (scuo *SystemConfigUpdateOne) sqlSave(ctx context.Context) (_node *SystemConfig, err error) {
	...
	_spec.Node.Schema = scuo.schemaConfig.SystemConfig
