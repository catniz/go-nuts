...
func (scd *SystemConfigDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(systemconfig.Table, sqlgraph.NewFieldSpec(systemconfig.FieldID, field.TypeUint64))
	_spec.Node.Schema = scd.schemaConfig.SystemConfig
