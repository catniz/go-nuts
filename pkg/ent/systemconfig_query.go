...
func (scq *SystemConfigQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (scq *SystemConfigQuery) FirstIDX(ctx context.Context) uint64 {
...
func (scq *SystemConfigQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (scq *SystemConfigQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (scq *SystemConfigQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (scq *SystemConfigQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := scq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (scq *SystemConfigQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SystemConfig, error) {
	...
	_spec.Node.Schema = scq.schemaConfig.SystemConfig
	ctx = internal.NewSchemaConfigContext(ctx, scq.schemaConfig)
...
func (scq *SystemConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(systemconfig.Table, systemconfig.Columns, sqlgraph.NewFieldSpec(systemconfig.FieldID, field.TypeUint64))
	_spec.From = scq.sql
...
func (scq *SystemConfigQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(scq.schemaConfig.SystemConfig)
	ctx = internal.NewSchemaConfigContext(ctx, scq.schemaConfig)
